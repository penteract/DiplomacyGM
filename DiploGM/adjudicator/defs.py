...
class AdjudicableOrder:
    ...
    def __str__(self):
        ...
        return f"{self.current_province.order_str()} {self.type} {self.source_province.order_str() if self.source_province else ''} {self.destination_province.order_str()} [{self.state}:{self.resolution}]"
